...
bed=read.csv("~/projects/Penicillium/genome_graphs/SLR_plots/within_genomes/GENOME.SRGs.FLANK2kb_flank.bed", sep='\t', header=T)
...
SLRbed=read.csv("~/projects/Penicillium/genome_graphs/SLR_plots/within_genomes/GENOME.SRGs.FLANK2kb_flank.SRG.bed", sep='\t', header=T)
...
genes=read.csv("~/projects/Penicillium/genome_graphs/SLR_plots/within_genomes/GENOME.SRGs.FLANK2kb_flank.genes.bed", sep='\t', header=T)
...
links=read_links("~/projects/Penicillium/genome_graphs/SLR_plots/within_genomes/GENOME.SRGs.FLANK2kb_flank.nucmer.paf")
...
ggsave(filename="~/projects/Penicillium/genome_graphs/SLR_plots/within_genomes/GENOME.SRGs.FLANK2kb_flank.pdf", 
       plot = plot, 
       device = cairo_pdf, 
       width = 210, 
       height = 297, 
...
ggsave(filename="~/projects/Penicillium/genome_graphs/SLR_plots/within_genomes/GENOME.SRGs.FLANK2kb_flank.adjacent_only.all_alignments.pdf", 
       plot = plot2, 
       device = cairo_pdf, 
       width = 210, 
       height = 297, 
...
ggsave(filename="~/projects/Penicillium/genome_graphs/SLR_plots/within_genomes/GENOME.SRGs.FLANK2kb_flank.adjacent_only.pdf", 
       plot = plot3, 
       device = cairo_pdf, 
       width = 210, 
       height = 297, 
